...
const WaitforDriver = (props) => {
  return (
    <div className="flex flex-col px-4 py-3 max-w-2xl gap-8">
      <h5
        onClick={() => {
      ...
      <div>
        ...
        ring-2 ring-green-700 mt-1 px-2 py-1 rounded hover:ring-fuchsia-900 gap-1 justify-between"
        >
          <div>
            <p className="text-xl ">Driver name</p>
            <h2
              className="text-xl bg-amber-100 inline-block rounded-xl px-3  py-1
            font-semibold"
            >
      ...
      <div className="">
        <p className="text-xl">Pickup location</p>
        <p
          className="text-lg bg-amber-200 inline-block rounded-3xl px-3  py-1
        font-bold mt-2"
        >
          {props.ride?.pickup}
        </p>
